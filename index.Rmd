...
- The [Final Report page](final.html) describes the three elements of the final submission (the report, the video and the self-evaluation) that you will build in **October** and provides submission instructions.
- [Examples & Tips](examples.html) contains information on sample work and other tips we've prepared to help you find your way through Project A.
...
- **Project A deliverables**. There are two deadlines.
    ...
    - by **Monday 2021-11-01 at 9 PM**, a final submission consisting of:
...
- **The Data**: You will be working with data from the 2021 edition of [County Health Rankings](https://www.countyhealthrankings.org/). 
    ...
    - The data are available now online with extensive additional information available at the [County Health Rankings website](https://www.countyhealthrankings.org/explore-health-rankings/measures-data-sources/2021-measures).
