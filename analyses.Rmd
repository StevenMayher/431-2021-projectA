...
Using the tibble you've developed following the instructions on the [Data](data.html) and [Proposal](proposal.html) pages, you will then create the remainder of your report by performing the analytic tasks specified below.
...
Dr. Love has provided a detailed outline for each of these Analyses as part of the [Examples & Tips](exampleB.html) page. You'll find that outline incorporated into the descriptions below, too.
...
The [outline Dr. Love has prepared for Analysis 1](exampleB.html) includes the following subsections. See that outline for more details in terms of what needs to go where, and additional guidance to help you complete the project effectively.
...
The [outline Dr. Love has prepared for Analysis 2](exampleB.html) includes the following subsections. See that outline for more details in terms of what needs to go where, and additional guidance to help you complete the project effectively.
...
The [outline Dr. Love has prepared for Analysis 3](exampleB.html) includes the following subsections. See that outline for more details in terms of what needs to go where, and additional guidance to help you complete the project effectively.
