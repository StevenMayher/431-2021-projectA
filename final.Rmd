...
Note that there is a [checklist for the final report](check_final.html) as part of the [Examples & Hints](check_final.html) page that includes many things we'll be looking for in grading. It's well worth your time to review the checklist before submitting your work.
...
3. **The Self-Evaluation** Once you have submitted the other two elements of your project, you will each (whether working alone or with a partner) submit a brief self-evaluation via the Google Form at https://bit.ly/431-2021-projA-self-evaluation. The form should take about 10 minutes to complete.
...
All three elements are due on Tuesday **2021-11-02 at 9 PM** as is now indicated on the [Course Calendar](https://thomaselove.github.io/431/calendar.html). 
...
- The Report is worth 40 points. It is unlikely that anyone will score above 37 points, which is the planned score for a completely accurate and polished report. Most scores will likely fall between 25 and 35 points on this element.
    ...
    - Most of the feedback you will receive on your Project A report will relate to specific grading criteria and a rubric that will be evaluated (mostly) by the teaching assistants. The checklist we used to help build the rubric is available to you as part of the [Examples & Hints](check_final.html) page.
